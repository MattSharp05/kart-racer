...
- The game side is `src/records/leaderboard.ts`: after a race started from the menus or a room (never a scenario), a personal best (MK-44 records) is submitted with the profile's nickname and device id.
